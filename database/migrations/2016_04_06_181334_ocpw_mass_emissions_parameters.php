...
class OcpwMassEmissionsParameters extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ocpw_mass_emissions_parameters', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('ocpw_mass_emissions_parameters');
    }
}
